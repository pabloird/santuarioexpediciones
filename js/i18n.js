...
const I18N = {
  ...
  "home.revTaCount": { es: "2 reseñas", en: "2 reviews" },
  ...
  "contact.hoursTitle": { es: "Horario de atención", en: "Opening hours" },
  "contact.hoursDir": { es: "Cómo llegar", en: "Get directions" },
  "contact.dayMon": { es: "Lunes", en: "Monday" },
  "contact.dayTue": { es: "Martes", en: "Tuesday" },
  "contact.dayWed": { es: "Miércoles", en: "Wednesday" },
  "contact.dayThu": { es: "Jueves", en: "Thursday" },
  "contact.dayFri": { es: "Viernes", en: "Friday" },
  "contact.daySat": { es: "Sábado", en: "Saturday" },
  "contact.daySun": { es: "Domingo", en: "Sunday" },

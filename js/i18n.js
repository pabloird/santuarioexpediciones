...
const I18N = {
  ...
  "ui.waTwoDay": { es: "Hola, quiero reservar la Expedición 2 días — Kayak + Glamping en el humedal. Una noche bajo las estrellas en glamping junto al humedal. Dos días de naturaleza, aves y silencio, con alojamiento incluido.", en: "Hi, I'd like to book the 2-day expedition — Kayak + Glamping by the wetland. A night under the stars in a glamping tent by the wetland. Two days of nature, birds and silence, with accommodation included.", fr: "Bonjour, je souhaite réserver l'Expédition 2 jours — Kayak + Glamping au bord du marais. Une nuit sous les étoiles en glamping au bord du marais. Deux jours de nature, d'oiseaux et de silence, hébergement inclus.", pt: "Olá, quero reservar a Expedição 2 dias — Caiaque + Glamping junto ao pântano. Uma noite sob as estrelas em glamping junto ao pântano. Dois dias de natureza, aves e silêncio, com hospedagem incluída." },
  ...
  "kayak.opTitle": { es: "Cinco formatos, un mismo humedal", en: "Five formats, one wetland", fr: "Cinq formats, un même marais", pt: "Cinco formatos, um mesmo pântano" },
